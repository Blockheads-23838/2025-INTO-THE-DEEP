...
public  class Constants {
    // ------------ PIVOT -------------
    public static double pivot_coefficent = 2;
    public static double pivot_kP = 0.001;
    public static double pivot_kF_slide_retracted = 0.3;
    public static double pivot_intake_pose = -120.0; //encoder counts; lowest the arm should go
    public static double pivot_high_pose = -1800; //encoder counts; highest the arm should go; high basket
    public static double pivot_kF_increase_per_slide_inch_extension = .000001;
